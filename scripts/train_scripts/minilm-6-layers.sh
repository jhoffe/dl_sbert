...
#BSUB -o logs/MiniLM6_%J.out
#BSUB -e logs/MiniLM6_%J.err
...
python main.py --batch_size=64 --precision=16-mixed --num_steps=10000 --model=nreimers/MiniLM-L6-H384-uncased
