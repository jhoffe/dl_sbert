...
#BSUB -o logs/MiniLM_%J.out
#BSUB -e logs/MiniLM_%J.err
...
python main.py --batch_size=64 --precision=16-mixed --num_steps=10000 --model=microsoft/MiniLM-L12-H384-uncased
